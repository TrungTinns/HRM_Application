...
import 'package:hrm_application/presentation/views/services/recruitmentServices/candidate_application/Application/candidate_application.dart';
import 'package:hrm_application/presentation/views/services/recruitmentServices/candidate_application/Data/cadidate_data.dart';
import 'package:hrm_application/presentation/views/services/recruitmentServices/candidate_application/Progress/application_progress.dart';
...
class _ApplicationManageState extends State<ApplicationManage> {
  ...
  Widget build(BuildContext context) {
    var primaryColor2 = primaryColor;
    return Scaffold(
      appBar: AppBar(
