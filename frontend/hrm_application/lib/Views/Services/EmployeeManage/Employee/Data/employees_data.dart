...
import 'package:hrm_application/Config/Platform/platform_options.dart';
...
class EmployeeData {
  ...
  static final List<String> defaultCertifications = [
    'Graduated',
    'Bachelor',
    'Master',
    'Doctor'
  ];
  static final List<String> defaultMaritalStatus = [
    'Single',
    'Married',
    'Legal Cohabitant',
    'Divorced',
  ...
  factory EmployeeData.fromJson(Map<String, dynamic> json) {
    return EmployeeData(
      ...
      contract: ContractData.fromJson(json['contract']) as ContractData? ??
          ContractData(),
    );
  }
}
...
Future<List<EmployeeData>> fetchEmployees() async {
  try {
    ...
    print(
        'Using API at: http://${PlatformOptions.host}:${PlatformOptions.port}/api/v1/employee');
      ...
      fromJson: (json) {
        return EmployeeData(
          ...
          contract: json['contract'] != null
              ? ContractData.fromJson(json['contract'])
              : null,
        );
      },
    );
...
Future<List<EmployeeData>> fetchManagers() async {
  try {
    ...
    // Kiểm tra giá trị của host và port
    print(
        'Using API at: http://${PlatformOptions.host}:${PlatformOptions.port}/api/v1/employee/managers');
