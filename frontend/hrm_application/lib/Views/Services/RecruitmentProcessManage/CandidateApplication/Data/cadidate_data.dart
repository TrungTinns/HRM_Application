...
class CandidateData {
  ...
  static final List<String> defaultStages = [
    'New',
  ...
  factory CandidateData.fromJson(Map<String, dynamic> json) {
    return CandidateData(
      ...
      availability: json['availability'] != null
          ? DateTime.parse(json['availability'])
          : null,
...
Future<List<CandidateData>> fetchCandidates() async {
  try {
    ...
    print(
        'Using API at: http://${PlatformOptions.host}:${PlatformOptions.port}/api/v1/recruitment/candidate');
